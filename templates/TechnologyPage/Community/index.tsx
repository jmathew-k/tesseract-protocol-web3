...
const community = [
    ...
    },
    {
        value: "90M+",
        content:
            "Stay current on the latest Tesseract project developments, news, and content, updated daily. Stay current on the latest Tesseract project developments, news, and content, updated daily.",
    },
    {
        value: "220K+",
        content:
                ...
                <div className={styles.row}>
                    <div className={styles.details}>
                        ...
                        <div className={styles.info}>
                            Stay current on the latest Tesseract project.
                        </div>
                    </div>
                    <Socials
